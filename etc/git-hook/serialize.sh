...
#
# To enable this hook, rename this file to "pre-commit" and save it in the directory <your git clone root>/.git/hooksj
#

# Customized by the git user
export JAVA_HOME="/c/Program Files (x86)/Java/jre1.8.0_101"
